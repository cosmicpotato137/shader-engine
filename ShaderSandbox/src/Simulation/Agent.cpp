...
const glm::vec2 &Agent::GetPosition() const { return position; }

const glm::vec2 &Agent::GetVelocity() const { return velocity; }

const glm::vec2 Agent::GetLastPosition() const { return lastPosition; }
